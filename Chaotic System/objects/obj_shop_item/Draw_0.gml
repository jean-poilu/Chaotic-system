...
if (!sold) {
	...
	draw_text_transformed(x + 3, y + 100 + 3, "$" + string(price), 2, 2, 0);
} else {
	draw_set_color(c_red);
	draw_text_transformed(x + 3, y + 100 + 3, "SOLD", 2, 2, 0);
}
...
draw_text_transformed(x + 3, y - 100 + 3, string(title), 1.5, 1.5, 0);
